        ...
        {!loginData.isLoggedIn ? (
          ...
          <>
            ...
            <Card.Meta textAlign='center'  >
                  <a className="tooltip" href={`https://bicon.tracker.solidwallet.io/address/${addressData.publicAddress}`} rel="noopener noreferrer" target="_blank">
                  {addressData.publicAddress.slice([0],[10])}
                  
                  <span className="tooltiptext" href={`https://bicon.tracker.solidwallet.io/address/${addressData.publicAddress}`} rel="noopener noreferrer" target="_blank">
